...
import ir.maktab32.java.projects.scholarshipmanagement.features.scholarshipverification.usecase.FindByManagerUseCase;
...
@Service
public class FindByManagerUseCaseImpl implements FindByManagerUseCase {
