...
import ir.maktab32.java.projects.scholarshipmanagement.features.scholarshipverification.usecase.FindByStudentUseCase;
...
@Service
public class FindByStudentUseCaseImpl implements FindByStudentUseCase {
